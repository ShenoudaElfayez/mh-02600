{setTimeout(()=>document.body.classList.add("render"),60);const t=Array.from(document.querySelectorAll("nav.demos > .demo")),e=t=>{document.body.classList.remove("render"),document.body.addEventListener("transitionend",()=>window.location=t.href)};t.forEach(t=>t.addEventListener("click",t=>{t.preventDefault(),e(t.target)}))}!function(t,e){"function"==typeof define&&define.amd?define("ev-emitter/ev-emitter",e):"object"==typeof module&&module.exports?module.exports=e():t.EvEmitter=e()}("undefined"!=typeof window?window:this,function(){function t(){}var e=t.prototype;return e.on=function(t,e){if(t&&e){var n=this._events=this._events||{},i=n[t]=n[t]||[];return-1==i.indexOf(e)&&i.push(e),this}},e.once=function(t,e){if(t&&e){this.on(t,e);var n=this._onceEvents=this._onceEvents||{};return(n[t]=n[t]||{})[e]=!0,this}},e.off=function(t,e){var n=this._events&&this._events[t];if(n&&n.length){var i=n.indexOf(e);return-1!=i&&n.splice(i,1),this}},e.emitEvent=function(t,e){var n=this._events&&this._events[t];if(n&&n.length){var i=0,r=n[i];e=e||[];for(var s=this._onceEvents&&this._onceEvents[t];r;){var o=s&&s[r];o&&(this.off(t,r),delete s[r]),r.apply(this,e),r=n[i+=o?0:1]}return this}},t}),function(t,e){"use strict";"function"==typeof define&&define.amd?define(["ev-emitter/ev-emitter"],function(n){return e(t,n)}):"object"==typeof module&&module.exports?module.exports=e(t,require("ev-emitter")):t.imagesLoaded=e(t,t.EvEmitter)}(window,function(t,e){function n(t,e){for(var n in e)t[n]=e[n];return t}function i(t,e,r){return this instanceof i?("string"==typeof t&&(t=document.querySelectorAll(t)),this.elements=function(t){var e=[];if(Array.isArray(t))e=t;else if("number"==typeof t.length)for(var n=0;n<t.length;n++)e.push(t[n]);else e.push(t);return e}(t),this.options=n({},this.options),"function"==typeof e?r=e:n(this.options,e),r&&this.on("always",r),this.getImages(),o&&(this.jqDeferred=new o.Deferred),void setTimeout(function(){this.check()}.bind(this))):new i(t,e,r)}function r(t){this.img=t}function s(t,e){this.url=t,this.element=e,this.img=new Image}var o=t.jQuery,a=t.console;i.prototype=Object.create(e.prototype),i.prototype.options={},i.prototype.getImages=function(){this.images=[],this.elements.forEach(this.addElementImages,this)},i.prototype.addElementImages=function(t){"IMG"==t.nodeName&&this.addImage(t),!0===this.options.background&&this.addElementBackgroundImages(t);var e=t.nodeType;if(e&&u[e]){for(var n=t.querySelectorAll("img"),i=0;i<n.length;i++){var r=n[i];this.addImage(r)}if("string"==typeof this.options.background){var s=t.querySelectorAll(this.options.background);for(i=0;i<s.length;i++){var o=s[i];this.addElementBackgroundImages(o)}}}};var u={1:!0,9:!0,11:!0};return i.prototype.addElementBackgroundImages=function(t){var e=getComputedStyle(t);if(e)for(var n=/url\((['"])?(.*?)\1\)/gi,i=n.exec(e.backgroundImage);null!==i;){var r=i&&i[2];r&&this.addBackground(r,t),i=n.exec(e.backgroundImage)}},i.prototype.addImage=function(t){var e=new r(t);this.images.push(e)},i.prototype.addBackground=function(t,e){var n=new s(t,e);this.images.push(n)},i.prototype.check=function(){function t(t,n,i){setTimeout(function(){e.progress(t,n,i)})}var e=this;return this.progressedCount=0,this.hasAnyBroken=!1,this.images.length?void this.images.forEach(function(e){e.once("progress",t),e.check()}):void this.complete()},i.prototype.progress=function(t,e,n){this.progressedCount++,this.hasAnyBroken=this.hasAnyBroken||!t.isLoaded,this.emitEvent("progress",[this,t,e]),this.jqDeferred&&this.jqDeferred.notify&&this.jqDeferred.notify(this,t),this.progressedCount==this.images.length&&this.complete(),this.options.debug&&a&&a.log("progress: "+n,t,e)},i.prototype.complete=function(){var t=this.hasAnyBroken?"fail":"done";if(this.isComplete=!0,this.emitEvent(t,[this]),this.emitEvent("always",[this]),this.jqDeferred){var e=this.hasAnyBroken?"reject":"resolve";this.jqDeferred[e](this)}},r.prototype=Object.create(e.prototype),r.prototype.check=function(){return this.getIsImageComplete()?void this.confirm(0!==this.img.naturalWidth,"naturalWidth"):(this.proxyImage=new Image,this.proxyImage.addEventListener("load",this),this.proxyImage.addEventListener("error",this),this.img.addEventListener("load",this),this.img.addEventListener("error",this),void(this.proxyImage.src=this.img.src))},r.prototype.getIsImageComplete=function(){return this.img.complete&&void 0!==this.img.naturalWidth},r.prototype.confirm=function(t,e){this.isLoaded=t,this.emitEvent("progress",[this,this.img,e])},r.prototype.handleEvent=function(t){var e="on"+t.type;this[e]&&this[e](t)},r.prototype.onload=function(){this.confirm(!0,"onload"),this.unbindEvents()},r.prototype.onerror=function(){this.confirm(!1,"onerror"),this.unbindEvents()},r.prototype.unbindEvents=function(){this.proxyImage.removeEventListener("load",this),this.proxyImage.removeEventListener("error",this),this.img.removeEventListener("load",this),this.img.removeEventListener("error",this)},s.prototype=Object.create(r.prototype),s.prototype.check=function(){this.img.addEventListener("load",this),this.img.addEventListener("error",this),this.img.src=this.url,this.getIsImageComplete()&&(this.confirm(0!==this.img.naturalWidth,"naturalWidth"),this.unbindEvents())},s.prototype.unbindEvents=function(){this.img.removeEventListener("load",this),this.img.removeEventListener("error",this)},s.prototype.confirm=function(t,e){this.isLoaded=t,this.emitEvent("progress",[this,this.element,e])},i.makeJQueryPlugin=function(e){(e=e||t.jQuery)&&((o=e).fn.imagesLoaded=function(t,e){return new i(this,t,e).jqDeferred.promise(o(this))})},i.makeJQueryPlugin(),i});var $jscomp={scope:{}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(t,e,n){if(n.get||n.set)throw new TypeError("ES3 does not support getters and setters.");t!=Array.prototype&&t!=Object.prototype&&(t[e]=n.value)},$jscomp.getGlobal=function(t){return"undefined"!=typeof window&&window===t?t:"undefined"!=typeof global&&null!=global?global:t},$jscomp.global=$jscomp.getGlobal(this),$jscomp.SYMBOL_PREFIX="jscomp_symbol_",$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){},$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)},$jscomp.symbolCounter_=0,$jscomp.Symbol=function(t){return $jscomp.SYMBOL_PREFIX+(t||"")+$jscomp.symbolCounter_++},$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var t=$jscomp.global.Symbol.iterator;t||(t=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator")),"function"!=typeof Array.prototype[t]&&$jscomp.defineProperty(Array.prototype,t,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}}),$jscomp.initSymbolIterator=function(){}},$jscomp.arrayIterator=function(t){var e=0;return $jscomp.iteratorPrototype(function(){return e<t.length?{done:!1,value:t[e++]}:{done:!0}})},$jscomp.iteratorPrototype=function(t){return $jscomp.initSymbolIterator(),(t={next:t})[$jscomp.global.Symbol.iterator]=function(){return this},t},$jscomp.array=$jscomp.array||{},$jscomp.iteratorFromArray=function(t,e){$jscomp.initSymbolIterator(),t instanceof String&&(t+="");var n=0,i={next:function(){if(n<t.length){var r=n++;return{value:e(r,t[r]),done:!1}}return i.next=function(){return{done:!0,value:void 0}},i.next()}};return i[Symbol.iterator]=function(){return i},i},$jscomp.polyfill=function(t,e,n,i){if(e){for(n=$jscomp.global,t=t.split("."),i=0;i<t.length-1;i++){var r=t[i];r in n||(n[r]={}),n=n[r]}(e=e(i=n[t=t[t.length-1]]))!=i&&null!=e&&$jscomp.defineProperty(n,t,{configurable:!0,writable:!0,value:e})}},$jscomp.polyfill("Array.prototype.keys",function(t){return t||function(){return $jscomp.iteratorFromArray(this,function(t){return t})}},"es6-impl","es3");var $jscomp$this=this;!function(t,e){"function"==typeof define&&define.amd?define([],e):"object"==typeof module&&module.exports?module.exports=e():t.anime=e()}(this,function(){function t(t){if(!A.col(t))try{return document.querySelectorAll(t)}catch(t){}}function e(t,e){for(var n=t.length,i=2<=arguments.length?arguments[1]:void 0,r=[],s=0;s<n;s++)if(s in t){var o=t[s];e.call(i,o,s,t)&&r.push(o)}return r}function n(t){return t.reduce(function(t,e){return t.concat(A.arr(e)?n(e):e)},[])}function i(e){return A.arr(e)?e:(A.str(e)&&(e=t(e)||e),e instanceof NodeList||e instanceof HTMLCollection?[].slice.call(e):[e])}function r(t,e){return t.some(function(t){return t===e})}function s(t){var e,n={};for(e in t)n[e]=t[e];return n}function o(t,e){var n,i=s(t);for(n in t)i[n]=e.hasOwnProperty(n)?e[n]:t[n];return i}function a(t,e){var n,i=s(t);for(n in e)i[n]=A.und(t[n])?e[n]:t[n];return i}function u(t){if(t=/([\+\-]?[0-9#\.]+)(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(t))return t[2]}function c(t,e){return A.fnc(t)?t(e.target,e.id,e.total):t}function h(t,e){if(e in t.style)return getComputedStyle(t).getPropertyValue(e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase())||"0"}function l(t,e){return A.dom(t)&&r(I,e)?"transform":A.dom(t)&&(t.getAttribute(e)||A.svg(t)&&t[e])?"attribute":A.dom(t)&&"transform"!==e&&h(t,e)?"css":null!=t[e]?"object":void 0}function d(t,n){switch(l(t,n)){case"transform":return function(t,n){var i=function(t){return-1<t.indexOf("translate")||"perspective"===t?"px":-1<t.indexOf("rotate")||-1<t.indexOf("skew")?"deg":void 0}(n);if(i=-1<n.indexOf("scale")?1:0+i,!(t=t.style.transform))return i;for(var r=[],s=[],o=[],a=/(\w+)\((.+?)\)/g;r=a.exec(t);)s.push(r[1]),o.push(r[2]);return(t=e(o,function(t,e){return s[e]===n})).length?t[0]:i}(t,n);case"css":return h(t,n);case"attribute":return t.getAttribute(n)}return t[n]||0}function f(t,e){var n=/^(\*=|\+=|-=)/.exec(t);if(!n)return t;var i=u(t)||0;switch(e=parseFloat(e),t=parseFloat(t.replace(n[0],"")),n[0][0]){case"+":return e+t+i;case"-":return e-t+i;case"*":return e*t+i}}function m(t,e){return Math.sqrt(Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2))}function p(t){t=t.points;for(var e,n=0,i=0;i<t.numberOfItems;i++){var r=t.getItem(i);0<i&&(n+=m(e,r)),e=r}return n}function g(t){if(t.getTotalLength)return t.getTotalLength();switch(t.tagName.toLowerCase()){case"circle":return 2*Math.PI*t.getAttribute("r");case"rect":return 2*t.getAttribute("width")+2*t.getAttribute("height");case"line":return m({x:t.getAttribute("x1"),y:t.getAttribute("y1")},{x:t.getAttribute("x2"),y:t.getAttribute("y2")});case"polyline":return p(t);case"polygon":var e=t.points;return p(t)+m(e.getItem(e.numberOfItems-1),e.getItem(0))}}function v(t,e){function n(n){return n=void 0===n?0:n,t.el.getPointAtLength(1<=e+n?e+n:0)}var i=n(),r=n(-1),s=n(1);switch(t.property){case"x":return i.x;case"y":return i.y;case"angle":return 180*Math.atan2(s.y-r.y,s.x-r.x)/Math.PI}}function y(t,e){var n,i=/-?\d*\.?\d+/g;if(n=A.pth(t)?t.totalLength:t,A.col(n))if(A.rgb(n)){var r=/rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(n);n=r?"rgba("+r[1]+",1)":n}else n=A.hex(n)?function(t){t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(t,e,n,i){return e+e+n+n+i+i});var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return"rgba("+(t=parseInt(e[1],16))+","+parseInt(e[2],16)+","+(e=parseInt(e[3],16))+",1)"}(n):A.hsl(n)?function(t){function e(t,e,n){return 0>n&&(n+=1),1<n&&--n,n<1/6?t+6*(e-t)*n:.5>n?e:n<2/3?t+(e-t)*(2/3-n)*6:t}var n=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t)||/hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(t);t=parseInt(n[1])/360;var i=parseInt(n[2])/100,r=parseInt(n[3])/100;if(n=n[4]||1,0==i)r=i=t=r;else{var s=.5>r?r*(1+i):r+i-r*i,o=2*r-s;r=e(o,s,t+1/3),i=e(o,s,t),t=e(o,s,t-1/3)}return"rgba("+255*r+","+255*i+","+255*t+","+n+")"}(n):void 0;else r=(r=u(n))?n.substr(0,n.length-r.length):n,n=e&&!/\s/g.test(n)?r+e:r;return{original:n+="",numbers:n.match(i)?n.match(i).map(Number):[0],strings:A.str(t)||e?n.split(i):[]}}function b(t){return e(t=t?n(A.arr(t)?t.map(i):i(t)):[],function(t,e,n){return n.indexOf(t)===e})}function w(t,e){var n=s(e);if(A.arr(t)){var r=t.length;2!==r||A.obj(t[0])?A.fnc(e.duration)||(n.duration=e.duration/r):t={value:t}}return i(t).map(function(t,n){return n=n?0:e.delay,t=A.obj(t)&&!A.pth(t)?t:{value:t},A.und(t.delay)&&(t.delay=n),t}).map(function(t){return a(t,n)})}function $(t,e){var n;return t.tweens.map(function(i){var r=(i=function(t,e){var n,i={};for(n in t){var r=c(t[n],e);A.arr(r)&&1===(r=r.map(function(t){return c(t,e)})).length&&(r=r[0]),i[n]=r}return i.duration=parseFloat(i.duration),i.delay=parseFloat(i.delay),i}(i,e)).value,s=d(e.target,t.name),o=n?n.to.original:s,a=(o=A.arr(r)?r[0]:o,f(A.arr(r)?r[1]:r,o));return s=u(a)||u(o)||u(s),i.from=y(o,s),i.to=y(a,s),i.start=n?n.end:t.offset,i.end=i.start+i.delay+i.duration,i.easing=function(t){return A.arr(t)?k.apply(this,t):D[t]}(i.easing),i.elasticity=(1e3-Math.min(Math.max(i.elasticity,1),999))/1e3,i.isPath=A.pth(r),i.isColor=A.col(i.from.original),i.isColor&&(i.round=1),n=i})}function x(t,e,n,i){var r="delay"===t;return e.length?(r?Math.min:Math.max).apply(Math,e.map(function(e){return e[t]})):r?i.delay:n.offset+i.delay+i.duration}function j(t){var i,r=o(E,t),s=o(S,t),u=function(t){var e=b(t);return e.map(function(t,n){return{target:t,id:n,total:e.length}})}(t.targets),c=[],h=a(r,s);for(i in t)h.hasOwnProperty(i)||"targets"===i||c.push({name:i,offset:h.offset,tweens:w(t[i],s)});return t=function(t,i){return e(n(u.map(function(t){return i.map(function(e){var n=l(t.target,e.name);if(n){var i=$(e,t);e={type:n,property:e.name,animatable:t,tweens:i,duration:i[i.length-1].end,delay:i[0].delay}}else e=void 0;return e})})),function(t){return!A.und(t)})}(0,c),a(r,{children:[],animatables:u,animations:t,duration:x("duration",t,r,s),delay:x("delay",t,r,s)})}function M(t){function n(){return window.Promise&&new Promise(function(t){return d=t})}function i(t){return m.reversed?m.duration-t:t}function r(t){for(var n=0,i={},r=m.animations,s=r.length;n<s;){var o=r[n],a=o.animatable,u=(c=o.tweens)[f=c.length-1];f&&(u=e(c,function(e){return t<e.end})[0]||u);for(var c=Math.min(Math.max(t-u.start-u.delay,0),u.duration)/u.duration,l=isNaN(c)?1:u.easing(c,u.elasticity),d=(c=u.to.strings,u.round),f=[],p=void 0,g=(p=u.to.numbers.length,0);g<p;g++){var y=void 0,b=(y=u.to.numbers[g],u.from.numbers[g]);y=u.isPath?v(u.value,l*y):b+l*(y-b),d&&(u.isColor&&2<g||(y=Math.round(y*d)/d)),f.push(y)}if(u=c.length)for(p=c[0],l=0;l<u;l++)d=c[l+1],g=f[l],isNaN(g)||(p=d?p+(g+d):p+(g+" "));else p=f[0];L[o.type](a.target,o.property,p,i,a.id),o.currentValue=p,n++}if(n=Object.keys(i).length)for(r=0;r<n;r++)O||(O=h(document.body,"transform")?"transform":"-webkit-transform"),m.animatables[r].target.style[O]=i[r].join(" ");m.currentTime=t,m.progress=t/m.duration*100}function s(t){m[t]&&m[t](m)}function o(){m.remaining&&!0!==m.remaining&&m.remaining--}function a(t){var e=m.duration,a=m.offset,h=a+m.delay,p=m.currentTime,g=m.reversed,v=i(t);if(m.children.length){var y=m.children,b=y.length;if(v>=m.currentTime)for(var w=0;w<b;w++)y[w].seek(v);else for(;b--;)y[b].seek(v)}(v>=h||!e)&&(m.began||(m.began=!0,s("begin")),s("run")),v>a&&v<e?r(v):(v<=a&&0!==p&&(r(0),g&&o()),(v>=e&&p!==e||!e)&&(r(e),g||o())),s("update"),t>=e&&(m.remaining?(c=u,"alternate"===m.direction&&(m.reversed=!m.reversed)):(m.pause(),m.completed||(m.completed=!0,s("complete"),"Promise"in window&&(d(),f=n()))),l=0)}t=void 0===t?{}:t;var u,c,l=0,d=null,f=n(),m=j(t);return m.reset=function(){var t=m.direction,e=m.loop;for(m.currentTime=0,m.progress=0,m.paused=!0,m.began=!1,m.completed=!1,m.reversed="reverse"===t,m.remaining="alternate"===t&&1===e?2:e,r(0),t=m.children.length;t--;)m.children[t].reset()},m.tick=function(t){u=t,c||(c=u),a((l+u-c)*M.speed)},m.seek=function(t){a(i(t))},m.pause=function(){var t=P.indexOf(m);-1<t&&P.splice(t,1),m.paused=!0},m.play=function(){m.paused&&(m.paused=!1,c=0,l=i(m.currentTime),P.push(m),_||C())},m.reverse=function(){m.reversed=!m.reversed,c=0,l=i(m.currentTime)},m.restart=function(){m.pause(),m.reset(),m.play()},m.finished=f,m.reset(),m.autoplay&&m.play(),m}var O,E={update:void 0,begin:void 0,run:void 0,complete:void 0,loop:1,direction:"normal",autoplay:!0,offset:0},S={duration:1e3,delay:0,easing:"easeOutElastic",elasticity:500,round:0},I="translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY perspective".split(" "),A={arr:function(t){return Array.isArray(t)},obj:function(t){return-1<Object.prototype.toString.call(t).indexOf("Object")},pth:function(t){return A.obj(t)&&t.hasOwnProperty("totalLength")},svg:function(t){return t instanceof SVGElement},dom:function(t){return t.nodeType||A.svg(t)},str:function(t){return"string"==typeof t},fnc:function(t){return"function"==typeof t},und:function(t){return void 0===t},hex:function(t){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(t)},rgb:function(t){return/^rgb/.test(t)},hsl:function(t){return/^hsl/.test(t)},col:function(t){return A.hex(t)||A.rgb(t)||A.hsl(t)}},k=function(){function t(t,e,n){return(((1-3*n+3*e)*t+(3*n-6*e))*t+3*e)*t}return function(e,n,i,r){if(0<=e&&1>=e&&0<=i&&1>=i){var s=new Float32Array(11);if(e!==n||i!==r)for(var o=0;11>o;++o)s[o]=t(.1*o,e,i);return function(o){if(e===n&&i===r)return o;if(0===o)return 0;if(1===o)return 1;for(var a=0,u=1;10!==u&&s[u]<=o;++u)a+=.1;u=a+(o-s[--u])/(s[u+1]-s[u])*.1;var c=3*(1-3*i+3*e)*u*u+2*(3*i-6*e)*u+3*e;if(.001<=c){for(a=0;4>a&&0!=(c=3*(1-3*i+3*e)*u*u+2*(3*i-6*e)*u+3*e);++a){var h=t(u,e,i)-o;u-=h/c}o=u}else if(0===c)o=u;else{u=a,a+=.1;var l=0;do{0<(c=t(h=u+(a-u)/2,e,i)-o)?a=h:u=h}while(1e-7<Math.abs(c)&&10>++l);o=h}return t(o,n,r)}}}}(),D=function(){function t(t,e){return 0===t||1===t?t:-Math.pow(2,10*(t-1))*Math.sin(2*(t-1-e/(2*Math.PI)*Math.asin(1))*Math.PI/e)}var e,n="Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),i={In:[[.55,.085,.68,.53],[.55,.055,.675,.19],[.895,.03,.685,.22],[.755,.05,.855,.06],[.47,0,.745,.715],[.95,.05,.795,.035],[.6,.04,.98,.335],[.6,-.28,.735,.045],t],Out:[[.25,.46,.45,.94],[.215,.61,.355,1],[.165,.84,.44,1],[.23,1,.32,1],[.39,.575,.565,1],[.19,1,.22,1],[.075,.82,.165,1],[.175,.885,.32,1.275],function(e,n){return 1-t(1-e,n)}],InOut:[[.455,.03,.515,.955],[.645,.045,.355,1],[.77,0,.175,1],[.86,0,.07,1],[.445,.05,.55,.95],[1,0,0,1],[.785,.135,.15,.86],[.68,-.55,.265,1.55],function(e,n){return.5>e?t(2*e,n)/2:1-t(-2*e+2,n)/2}]},r={linear:k(.25,.25,.75,.75)},s={};for(e in i)s.type=e,i[s.type].forEach(function(t){return function(e,i){r["ease"+t.type+n[i]]=A.fnc(e)?e:k.apply($jscomp$this,e)}}(s)),s={type:s.type};return r}(),L={css:function(t,e,n){return t.style[e]=n},attribute:function(t,e,n){return t.setAttribute(e,n)},object:function(t,e,n){return t[e]=n},transform:function(t,e,n,i,r){i[r]||(i[r]=[]),i[r].push(e+"("+n+")")}},P=[],_=0,C=function(){function t(){_=requestAnimationFrame(e)}function e(e){var n=P.length;if(n){for(var i=0;i<n;)P[i]&&P[i].tick(e),i++;t()}else cancelAnimationFrame(_),_=0}return t}();return M.version="2.2.0",M.speed=1,M.running=P,M.remove=function(t){t=b(t);for(var e=P.length;e--;)for(var n=P[e],i=n.animations,s=i.length;s--;)r(t,i[s].animatable.target)&&(i.splice(s,1),i.length||n.pause())},M.getValue=d,M.path=function(e,n){var i=A.str(e)?t(e)[0]:e,r=n||100;return function(t){return{el:i,property:t,totalLength:g(i)*(r/100)}}},M.setDashoffset=function(t){var e=g(t);return t.setAttribute("stroke-dasharray",e),e},M.bezier=k,M.easings=D,M.timeline=function(t){var e=M(t);return e.pause(),e.duration=0,e.add=function(n){return e.children.forEach(function(t){t.began=!0,t.completed=!0}),i(n).forEach(function(n){var i=a(n,o(S,t||{}));i.targets=i.targets||t.targets,n=e.duration;var r=i.offset;i.autoplay=!1,i.direction=e.direction,i.offset=A.und(r)?n:f(r,n),e.began=!0,e.completed=!0,e.seek(i.offset),(i=M(i)).began=!0,i.completed=!0,i.duration>n&&(e.duration=i.duration),e.children.push(i)}),e.seek(0),e.reset(),e.autoplay&&e.restart(),e},e},M.random=function(t,e){return Math.floor(Math.random()*(e-t+1))+t},M});{function debounce(t,e,n){var i;return function(){var r=this,s=arguments,o=n&&!i;clearTimeout(i),i=setTimeout(function(){i=null,n||t.apply(r,s)},e),o&&t.apply(r,s)}}class t{constructor(t){this.DOM={},this.DOM.el=t,this.settings={animation:{slides:{duration:600,easing:"easeOutQuint"},shape:{duration:300,easing:{in:"easeOutQuad",out:"easeOutQuad"}}},frameFill:"var(--sec-color)"},this.init()}init(){this.DOM.slides=Array.from(this.DOM.el.querySelectorAll(".slides > .slide")),this.slidesTotal=this.DOM.slides.length,this.DOM.nav=this.DOM.el.querySelector(".slidenav"),this.DOM.nextCtrl=this.DOM.nav.querySelector(".slidenav__item--next"),this.DOM.prevCtrl=this.DOM.nav.querySelector(".slidenav__item--prev"),this.current=0,this.createFrame(),this.initEvents()}createFrame(){this.rect=this.DOM.el.getBoundingClientRect(),this.frameSize=this.rect.width/12,this.paths={initial:this.calculatePath("initial"),final:this.calculatePath("final")},this.DOM.svg=document.createElementNS("http://www.w3.org/2000/svg","svg"),this.DOM.svg.setAttribute("class","shape"),this.DOM.svg.setAttribute("width","100%"),this.DOM.svg.setAttribute("height","100%"),this.DOM.svg.setAttribute("viewbox",`0 0 ${this.rect.width} ${this.rect.height}`),this.DOM.svg.innerHTML=`<path fill="${this.settings.frameFill}" d="${this.paths.initial}"/>`,this.DOM.el.insertBefore(this.DOM.svg,this.DOM.nav),this.DOM.shape=this.DOM.svg.lastElementChild}updateFrame(){this.paths.initial=this.calculatePath("initial"),this.paths.final=this.calculatePath("final"),this.DOM.svg.setAttribute("viewbox",`0 0 ${this.rect.width} ${this.rect.height}`),this.DOM.shape.setAttribute("d",this.isAnimating?this.paths.final:this.paths.initial)}calculatePath(t="initial"){return"initial"===t?`M 0,0 0,${this.rect.height} ${this.rect.width},${this.rect.height} ${this.rect.width},0 0,0 Z M 0,0 ${this.rect.width},0 ${this.rect.width},${this.rect.height} 0,${this.rect.height} Z`:{next:`M 0,0 0,${this.rect.height} ${this.rect.width},${this.rect.height} ${this.rect.width},0 0,0 Z M ${this.frameSize},${this.frameSize} ${this.rect.width-this.frameSize},${this.frameSize/2} ${this.rect.width-this.frameSize},${this.rect.height-this.frameSize/2} ${this.frameSize},${this.rect.height-this.frameSize} Z`,prev:`M 0,0 0,${this.rect.height} ${this.rect.width},${this.rect.height} ${this.rect.width},0 0,0 Z M ${this.frameSize},${this.frameSize/2} ${this.rect.width-this.frameSize},${this.frameSize} ${this.rect.width-this.frameSize},${this.rect.height-this.frameSize} ${this.frameSize},${this.rect.height-this.frameSize/2} Z`}}initEvents(){this.DOM.nextCtrl.addEventListener("click",()=>this.navigate("next")),this.DOM.prevCtrl.addEventListener("click",()=>this.navigate("prev")),window.addEventListener("resize",debounce(()=>{this.rect=this.DOM.el.getBoundingClientRect(),this.updateFrame()},20)),document.addEventListener("keydown",t=>{const e=t.keyCode||t.which;37===e?this.navigate("prev"):39===e&&this.navigate("next")})}navigate(t="next"){if(this.isAnimating)return!1;this.isAnimating=!0,anime({targets:this.DOM.shape,duration:this.settings.animation.shape.duration,easing:this.settings.animation.shape.easing.in,d:"next"===t?this.paths.final.next:this.paths.final.prev}).finished.then(()=>new Promise((e,n)=>{const i=this.DOM.slides[this.current];anime({targets:i,duration:this.settings.animation.slides.duration,easing:this.settings.animation.slides.easing,translateX:"next"===t?-1*this.rect.width:this.rect.width,complete:()=>{i.classList.remove("slide--current"),e()}}),this.current="next"===t?this.current<this.slidesTotal-1?this.current+1:0:this.current>0?this.current-1:this.slidesTotal-1;const r=this.DOM.slides[this.current];r.classList.add("slide--current"),anime({targets:r,duration:this.settings.animation.slides.duration,easing:this.settings.animation.slides.easing,translateX:["next"===t?this.rect.width:-1*this.rect.width,0]});const s=r.querySelector(".slide__img");s.style.transformOrigin="next"===t?"-10% 50%":"110% 50%",anime.remove(s),anime({targets:s,duration:4*this.settings.animation.slides.duration,easing:"easeOutElastic",elasticity:350,scale:[1.2,1],rotate:["next"===t?4:-4,0]}),anime({targets:[r.querySelector(".slide__title"),r.querySelector(".slide__desc"),r.querySelector(".slide__link")],duration:this.settings.animation.slides.duration,easing:this.settings.animation.slides.easing,delay:(e,n,i)=>"next"===t?100*n+750:100*(i-n-1)+750,translateY:["next"===t?300:-300,0],rotate:[15,0],opacity:[0,1]})})).then(()=>{anime({targets:this.DOM.shape,duration:this.settings.animation.shape.duration,delay:150,easing:this.settings.animation.shape.easing.out,d:this.paths.initial,complete:()=>this.isAnimating=!1})})}}new t(document.querySelector(".slideshow")),imagesLoaded(".slide__img",{background:!0},()=>document.body.classList.remove("loading"))}
...
$(function(){"use strict";function e(){"en"===localStorage.getItem("lang")?"/"!=window.location.pathname&&"/index.html"!=window.location.pathname&&"/index.html/"!=window.location.pathname&&"/index"!=window.location.pathname&&"/index/"!=window.location.pathname||(window.location.pathname="/index-en.html"):"/index-en.html"!=window.location.pathname&&"/index-en.html/"!=window.location.pathname&&"/index-en"!=window.location.pathname&&"/index-en/"!=window.location.pathname||(window.location.pathname="/")}null==localStorage.getItem("lang")&&localStorage.setItem("lang","ar"),$(".lang-check").on("click",function(){localStorage.setItem("lang",$(this).data("lang-check")),e()}),e();var o=$("body"),t=$("aside#navbar-links.aside-en"),s=$("aside#navbar-links.aside-ar"),a=$("nav.main-nav"),n=$("header.main-header");$(".main-nav").find("button").click(function(){"true"===$(this).attr("aria-expanded")?$(this).find(".our-button").removeClass("transformed"):$(this).find(".our-button").addClass("transformed")});var i="",r="";$(window).on("resize",function(){i=a.innerHeight(),a.height(),r=t.innerWidth(),$(this).width()<=767.98?(t.css({top:i+"px",height:"calc(100% - "+i+"px)"}),s.css({top:i+"px",height:"calc(100% - "+i+"px)"})):(t.css({top:0,height:"100%"}),s.css({top:0,height:"100%"}))}).trigger("resize"),$("button.navbar-toggler.collapsed").on("click",function(){"false"===$(this).attr("aria-expanded")?(t.animate({left:"0"},400),s.animate({right:"0"},400),o.addClass("overflow-body-js")):($(this).width()<=767.98?(t.animate({left:"-100vw"},400),s.animate({right:"-100vw"},400)):(t.animate({left:-r+"px"},400),s.animate({right:-r+"px"},400)),o.removeClass("overflow-body-js"))}),$(".nav-link").on("click",function(e){e.preventDefault()}),$(window).scroll(function(){var e=n,t=e.offset().top+e.outerHeight()-i-1;$(this).scrollTop()>=t?a.removeClass("nav-absolute-js").addClass("nav-fixed-js"):a.removeClass("nav-fixed-js").addClass("nav-absolute-js"),O()}).trigger("scroll"),$("section.our-courses .shuffle li").on("click",function(){$(this).addClass("active").siblings(".active").removeClass("active");var e=$($("section.our-courses .shuffle .ul-years li.active").data("years")+$("section.our-courses .shuffle .ul-terms li.active").data("terms"));$(".container-courses").addClass("animation-none").fadeOut(400,function(){e.fadeIn(400)})}),setInterval(function(){$('a[href="https://www.juicer.io?referrer=hesham4all"], section.latest-news .referral, section.latest-news .juicer-ad, .j-share').remove(),$("section.latest-news a, .j-overlay a").addClass("transition"),$("section.latest-news.section-en .feed-item.j-facebook.j-facebook-bg:odd").addClass("wow bounceInLeft"),$("section.latest-news.section-en .feed-item.j-facebook.j-facebook-bg:even").addClass("wow bounceInRight"),$("section.latest-news.section-ar .feed-item.j-facebook.j-facebook-bg:odd").addClass("wow bounceInRight"),$("section.latest-news.section-ar .feed-item.j-facebook.j-facebook-bg:even").addClass("wow bounceInLeft"),$("section.latest-news .j-stacker").addClass("overflow-hiddin"),$("section.latest-news img, .j-overlay img").attr("alt","img"),$('section.latest-news a[target="_blank"], .j-overlay a[target="_blank"]').attr("rel","noopener"),o.find(".j-overlay").length?o.addClass("overflow-h-popup"):o.removeClass("overflow-h-popup");var e=(new Date).getUTCMonth()+1,t=$("select#terms");t.attr("disabled",!0),2<=e&&e<=6?t.find("option.second-term").attr("selected","selected").siblings("option").removeAttr("selected"):t.find("option.first-term").attr("selected","selected").siblings("option").removeAttr("selected"),y()},50),[].slice.call($("option")).forEach(function(t){t.addEventListener("mousedown",function(e){return e.preventDefault(),t.parentElement.focus(),$(this).parents("select").focus(),this.selected=!this.selected,!1},!1)});var l=(new Date).getUTCFullYear();o.append("<footer id='main-footer' class='main-footer'><div class='container overflow-hidden'><div id='footer-left' class='footer-left'>created by :<a href='https://www.el-fayez.com/' target='_blank' rel='noopener'><img src='https://el-fayez.netlify.com/img/logo-name.svg' alt='El Fayez'/></a></div><div id='footer-right' class='footer-right'>copyright &copy; <span class='footer-year'></span></div></div></footer>"),$("#main-footer").css({color:"var(--white-alpha)",direction:"ltr",padding:".5em 0","font-size":"20px","font-family":"var(--font-family-en)",background:"#111"}),$("#main-footer #footer-left").css({float:"left"}),$("#main-footer #footer-left img").css({width:"80px",marginLeft:"10px"}),$("#main-footer #footer-right").css({float:"right"}),$("#main-footer #footer-right .footer-year").text(l),$(".plus.years-of-experience").attr("data-count",l-2010);var c=$("#name"),d=$("#email"),f=$("#phone"),m=$("#years"),u=$("#courses"),h=$("#message"),v=$("#submit"),p=!0,g=!0,w=!0,b=!0,C=!0,k=!0;function y(){1==p||1==g||1==w||1==C||1==b||1==k?v.attr("disabled",!0).addClass("erorr-submit"):v.removeAttr("disabled").removeClass("erorr-submit")}c.on("keyup keypress input blur",function(){p=4<=c.val().length?($(this).removeClass("erorr-form").addClass("success-form"),!1):($(this).removeClass("success-form").addClass("erorr-form"),!0),null===c.val().match(/[a-zA-Z ء-ي]/g)?$(this).val(""):$(this).val($(this).val().match(/[a-zA-Z ء-ي]/g).join("")),y()}),d.on("keyup keypress input blur",function(){if(-1!=d.val().indexOf("@")&&0!=d.val().indexOf("@")){var e=d.val().slice(d.val().indexOf("@")),t=d.val().slice(d.val().indexOf("@")+1,d.val().lastIndexOf(".")).search(/[a-zA-Z]/);g=-1!=e.indexOf(".")&&3<=e.slice(e.indexOf(".")).length&&-1!=t&&-1!==e.slice(e.indexOf(".")).search(/[a-zA-z]/)?($(this).removeClass("erorr-form").addClass("success-form"),!1):($(this).removeClass("success-form").addClass("erorr-form"),!0)}else $(this).removeClass("success-form").addClass("erorr-form"),g=!0;null===d.val().match(/[a-zA-z0-9-_.@]/g)?$(this).val(""):$(this).val($(this).val().match(/[a-zA-z0-9-_.@]/g).join("")),y()}),f.on("keyup keypress input blur",function(){w=11===$(this).val().length?($(this).removeClass("erorr-form").addClass("success-form"),!1):($(this).removeClass("success-form").addClass("erorr-form"),!0),null===f.val().match(/[0-9۰٠١۱٢۲٣۳٤٥۵٦٧۷٨۸٩۹]/g)?$(this).val(""):$(this).val($(this).val().match(/[0-9۰٠١۱٢۲٣۳٤٥۵٦٧۷٨۸٩۹]/g).join("")),y()}),m.on("change blur click touch",function(){C=null==$(this).val()?($(this).removeClass("success-form").addClass("erorr-form"),!0):($(this).removeClass("erorr-form").addClass("success-form"),!1),y();var e=$("select#terms").find("option[selected]").data("terms"),t=$(this).find(":selected").data("years");u.parent(".holder-select").removeClass("d-none").end().find("optgroup"+e+t).removeAttr("disabled").removeClass("d-none").siblings().attr("disabled",!0).addClass("d-none"),u.val([]),b=u.find("option:selected").length?(u.removeClass("erorr-form").addClass("success-form"),!1):(u.removeClass("success-form").addClass("erorr-form"),!0),y()}),u.on("change blur click touch",function(){b=$(this).find("option:selected").length?($(this).removeClass("erorr-form").addClass("success-form"),!1):($(this).removeClass("success-form").addClass("erorr-form"),!0),y()}),h.on("keyup keypress input blur",function(){k=3<=$(this).val().length?($(this).removeClass("erorr-form").addClass("success-form"),!1):($(this).removeClass("success-form").addClass("erorr-form"),!0),y()}),y(),c.on("keypress",function(){return e=event,t=String.fromCharCode(e.which),void(/[a-zA-Z ء-ي]/g.test(t)||e.preventDefault());var e,t}),d.on("keypress",function(){return e=event,t=String.fromCharCode(e.which),void(/[a-zA-z0-9-_.@]/.test(t)||e.preventDefault());var e,t}),f.on("keypress",function(){return e=event,t=String.fromCharCode(e.which),void(/[0-9۰٠١۱٢۲٣۳٤٥۵٦٧۷٨۸٩۹]/.test(t)||e.preventDefault());var e,t});var x=$("section.about-me").offset().top-i,j=$("section.our-courses").offset().top-i,z=$("section.latest-news").offset().top-i,I=$("#statistics.statistics").offset().top-i,A=$("section.contact-me").offset().top-i;function O(){$(".block").each(function(){if($(window).scrollTop()>=$(this).offset().top-(i+1)){var e=$(this).data("class");!1===$("ul li"+e).hasClass("active")&&$("ul li"+e).addClass("active").siblings().removeClass("active")}})}setInterval(function(){x=$("section.about-me").offset().top-i,j=$("section.our-courses").offset().top-i,z=$("section.latest-news").offset().top-i,I=$("#statistics.statistics").offset().top-i,A=$("section.contact-me").offset().top-i},10),$(".up-move, .about-me-move, .our-courses-move, .latest-news-move, .statistics-move, .book-now-move").on("click",function(){"true"===$("button.navbar-toggler").attr("aria-expanded")&&$("button.navbar-toggler").click()}),$(".up-move").on("click",function(){$("body, html").stop().animate({scrollTop:0},1e3)}),$(".about-me-move").on("click",function(){$("body, html").stop().animate({scrollTop:x},1e3)}),$(".our-courses-move").on("click",function(){$("body, html").stop().animate({scrollTop:j},1e3)}),$(".latest-news-move").on("click",function(){$("body, html").stop().animate({scrollTop:z},1e3)}),$(".statistics-move").on("click",function(){$("body, html").stop().animate({scrollTop:I},1e3)}),$(".book-now-move").on("click",function(){$("body, html").stop().animate({scrollTop:A},1e3)}),O()});var loading=$("section.loading-screen");$(window).on("load",function(){loading.delay(3e3).fadeOut(100,function(){$(this).remove(),$("body").removeClass("overflow-h-loader"),new WOW({offset:150}).init();var t=0;$(window).scroll(function(){var e=$("#statistics.statistics").offset().top-window.innerHeight;0==t&&$(window).scrollTop()>=e&&($("#statistics.statistics .plus").each(function(){var e=$(this),t=e.attr("data-count");$({countNum:e.text()}).animate({countNum:t},{duration:3e3,easing:"swing",step:function(){e.text(Math.floor(this.countNum))},complete:function(){e.text(this.countNum)}})}),t=1)}).trigger("scroll"),setInterval(function(){$(".slidenav__item.slidenav__item--next").click()},1e4)}),setInterval(function(){$("._1CFQA2vs").remove(),$('[data-test-id="manychat-logo"]').remove()},100)});
